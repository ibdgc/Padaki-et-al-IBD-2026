...
add_rs_to_pvar.pl big_daly.all_variants.txt big_daly_v3.pvar big_daly_v3.try1.pvar 

#replace stuff
mv bge_merge_v1.pvar bge_merge_v1.pvar.save
mv bge_try1.pvar bge_merge_v1.pvar
mv big_daly_v3.pvar big_daly_v3.pvar.save
mv big_daly_v3.try1.pvar big_daly_v3.pvar
...
#create plink and vcf files with just the those overlap variants

plink2 --extract big_daly_bge_subset.variants.txt --pfile big_daly_v3 --make-pgen --out big_daly_v3_bgesubset
plink2 --pfile big_daly_v3_bgesubset --export vcf --out big_daly_v3_bgesubset
gzip big_daly_v3_bgesubset.vcf

#upload the big_daly_v3_bgesubset.vcf.gz to bystro and have it annotated.
